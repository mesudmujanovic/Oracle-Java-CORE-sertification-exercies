package org.example.Games.Game3;

import org.example.Records.Main;
...
public class ScrabbleSolver {
    public static void main(String[] args) throws IOException {
        ...
        BufferedReader reader = new BufferedReader(new FileReader("C:/Users/MesudMujanovic(SJJ)/Desktop/mesud/word.txt"));
